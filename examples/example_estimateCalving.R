...
parturitions <- estimateCalving(caribou.mr, int=3, kcons =c(5,21), models = "full", PlotIt = TRUE)
head(parturitions)
...
parturitions$results[parturitions$results$ID == "Vixen" & parturitions$results$Year == 2008,] # "calfdeath"

getCalvingPlot(df = caribou.mr[caribou.mr$ID == "Vixen" & caribou.mr$Year == 2008,], int = 3,
