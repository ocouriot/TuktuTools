#' Parturition timing function considering 2 models
#'
#' Function that determine calving status of a female (i.e. no calf, with a calf)
#' the calving date and the recovery time (if any).
...
#' \item For the model representing females that had a calf:
...
#'
#' The models differ in their number of parameters to estimate:
...
#' the AIC of the 2 models (i.e. no calf model and calf model),
...
#'
#' @example examples/example_parturitionmodel2.R
#' 
#' @export
